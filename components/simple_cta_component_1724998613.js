...
-->
<template>
    <section id="cta-component" class="bg-gray-50 dark:bg-gray-800 flex-1" style=""><div id="cta-inner-container" class="max-w-screen-xl px-4 py-8 mx-auto lg:py-16 lg:px-6" style=""><div id="cta-content" class="max-w-screen-sm mx-auto text-center"><div id="cta-title-container" class="flex"><h2 id="cta-title" class="flex-1 mb-4 text-3xl font-extrabold leading-tight tracking-tight text-gray-900 dark:text-white" style="" data-mf-new="true">
                        Revolutionize Your Mobile Experience's</h2></div> <div id="cta-subtitle-container" class="flex"><p id="cta-subtitle" class="flex-1 mb-6 font-light text-gray-500 dark:text-gray-400 md:text-lg">
                        ...
                        Start Building Your Mobile your application
